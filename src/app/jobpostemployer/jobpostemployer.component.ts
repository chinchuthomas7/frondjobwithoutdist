...
import { FormArray, FormBuilder,AbstractControl, FormGroup, Validators, FormControl } from '@angular/forms';
import { Router } from '@angular/router';
import { JobportalService } from '../jobportal.service';

@Component({
  selector: 'app-jobpostemployer',
  templateUrl: './jobpostemployer.component.html',
  styleUrls: ['./jobpostemployer.component.css']
})
export class JobpostemployerComponent implements OnInit {
