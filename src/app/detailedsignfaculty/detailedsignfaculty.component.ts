...
@Component({
  selector: 'app-detailedsignfaculty',
  templateUrl: './detailedsignfaculty.component.html',
  styleUrls: ['./detailedsignfaculty.component.css']
})
export class DetailedsignfacultyComponent implements OnInit {
...
this.jobportalservice.newFacultyDetail(this.Client)
.subscribe(
  (res:any)=>{
